        ...
        public:
            ...
            class CXLResponsePort : public ResponsePort
            {
                ...
                public:
                    ...
                    CXLResponsePort(const std::string& _name, CXLSwitch& _bridge, bool upstream, uint8_t respID,uint8_t rcid , 
                            Cycles _delay,
                            //Tick _delay,
                            int _resp_limit);
            ...
            public:
                 ...
                 */
                CXLRequestPort(const std::string& _name, CXLSwitch& _bridge,uint8_t rcid , 
                                Cycles _delay,
                                // Tick _delay,
                                int _req_limit);
            ...
            public:
                CXLResponsePort responsePort1;
                CXLResponsePort responsePort2;
                CXLResponsePort responsePort_DMA1;
                CXLResponsePort responsePort_DMA2;
                CXLResponsePort responsePort_DMA3;
                CXLRequestPort requestPort_DMA;
                CXLRequestPort requestPort1;
                CXLRequestPort requestPort2;
                CXLRequestPort requestPort3;


                CXLRequestPort * getRequestPort(Addr address);
                CXLResponsePort * getResponsePort(int bus_num);
                virtual CXLRequestPort& getRequestPort(const std::string& if_name,
                                          PortID idx = InvalidPortID);
                virtual CXLResponsePort& getResponsePort(const std::string& if_name,
                                        PortID idx = InvalidPortID);
                ...
                void initialize_ports (config_class * storage_ptr , const CXLSwitchParams & p ) ; 
                ...
                // config_class *register_bridge_init(const CXLSwitchParams &p,CXLSwitch * bridge, int num);

                CXLSwitch(const CXLSwitchParams & p);
                ~CXLSwitch(); 
    };          
