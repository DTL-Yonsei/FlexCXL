...
class CXLDRAMsim3(PciDevice):
    ...
    validation_queue_capacity = Param.UInt32(
        0,
        "Explicit global outstanding capacity override; independent of "
        "validation logging, while zero preserves the native DRAMsim3 "
        "queue-size behavior",
    )
